		...
		handler: function (ev) {
			...
			switch (ev.type) {
				...
				case 'touchend': 
					...
					var newX = xStart - $("#tinderslide").position().left;
					var newY = yStart - $("#tinderslide").position().top;
					
					// alert (newX + " " + newY);
					if (newX >= 90 && newX < 210 && newY >= 500 && newY < 525) {
						var insta_link = $(this)[0].children.lis.children[current_pane].children[1].innerText;
						insta_link = insta_link.substr(2);
						// console.log(insta_link);
						if (insta_link) window.open('instagram://user?username=' + insta_link, '_system', 'location=no');
					}
					
					if (newX >= 220 && newX < 240 && newY >= 430 && newY < 465) {
//					//	 console.log($(this));
//					//	console.log(newY);
//						var photo_id = $(this)[0].children.lis.children[current_pane].id;
//					//	console.log($(this)[0].children.lis.children[current_pane].children[1].children[0].className);
//						var starClass = $(this)[0].children.lis.children[current_pane].children[2].children[0];
//						starClass.className += " md-red";
//					//	console.log($(this)[0].children.lis.children[current_pane].children[1].children[0].className);
//						goScrap(photo_id);
